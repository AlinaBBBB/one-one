            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    ...
                    <p class="lead mb-0" style="
                        ...
                        max-width: 500px;
                        margin: 0 auto;
                    ">Станьте частью мира минималистичной элегантности</p>
                </div>
            </div>
        </div>
    </div>
                ...
                ">
                    ...
                    <div class="card-body p-0 pt-4">
                        <form action="{{ route('register.store') }}" method="post">
                            ...
                            <!-- Name -->
                            <div class="mb-4">
                                <label for="name" class="form-label small" style="
                                    color: #444;
                                    font-weight: 500;
                            ...
                            <div class="mb-5">
                                <label for="password_confirmation" class="form-label small" style="
                                    color: #444;
                                    font-weight: 500;
                                    letter-spacing: 0.5px;
                                    margin-bottom: 8px;
                            ...
                            <div class="d-grid gap-2 mb-5">
                                <button class="btn py-3" type="submit" 
                                    ...
                                    <span style="position: relative; z-index: 2;">Создать аккаунт</span>
                                    <div style="
                                        position: absolute;
                                        top: 0;
                                        left: -100%;
                        ...
                        <div class="text-center pt-4 border-top" style="border-top: 1px solid #f0f0f0 !important;">
                            <p class="mb-0 small" style="color: #888;">
                                Уже есть аккаунт? 
                                <a href="{{ route('login') }}" class="text-decoration-none fw-medium text-dark" 
                                   style="
                                        color: #111 !important;
